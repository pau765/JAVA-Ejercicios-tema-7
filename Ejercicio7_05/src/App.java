...
public class App {
    public static void main(String[] args) throws Exception {
        CuentaCorriente c, c2, c3;
        Gestor g1 = new Gestor("Antonio Gonzalez", "666 555 444");
        Gestor g2 = new Gestor("Juan Perez", "987 543 210", 12000.0);
       ...
       System.out.print("Introduce el DNI: ");
        ...
        saldo = sc.nextDouble();*/
        c = new CuentaCorriente("12345678-Z", "Zoe", g1);
        c2 = new CuentaCorriente("98765432-L", "Luci", g1);
        c3 = new CuentaCorriente("11222333-P", "Pombo");
